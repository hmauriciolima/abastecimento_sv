...
with col_titulo:
    ...
    # Subtítulo técnico logo abaixo, com fonte menor e cor suave
...
# 4. FUNÇÕES PARA CARREGAR LISTAS DINÂMICAS
...
if btn_salvar:
    if not id_frota_res:
        st.error("❌ ERRO: Informe o ID da Frota!")
    elif qtd_res <= 0:
        st.warning("⚠️ Informe o volume.")
    else:
        pacote_dados = {
